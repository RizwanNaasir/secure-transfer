        ...
        <div class="col-span-2 col-span-2 p-12 pt-4">
            ...
            <div class="flex  items-center w-full" id="wrapper">
                <label for="dropzone-file"
                       class="flex flex-col justify-center items-center w-44 h-44 bg-gray-50 rounded-lg border-2 border-gray-300 border-dashed cursor-pointer dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
